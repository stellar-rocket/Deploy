...
module.exports = {
  ...
  site: {
    ...
    baseUrl: '{{ mongoexpress_root_url }}',
    cookieKeyName: 'mongo-express',
    cookieSecret: '{{ VAULT_MONGOEXPRESS_COOKIE_SECRET }}',
    host: process.env.VCAP_APP_HOST || 'localhost',
    port: process.env.VCAP_APP_PORT || '{{ mongoexpress_port }}',
    requestSizeLimit: process.env.ME_CONFIG_REQUEST_SIZE || '50mb',
    sessionSecret: '{{ VAULT_MONGOEXPRESS_SESSION_SECRET }}',
  ...
  basicAuth: {
    username: '{{ mongoexpress_admin_user }}',
    password: '{{ VAULT_MONGOEXPRESS_ADMIN_PASSWORD }}'
  },
